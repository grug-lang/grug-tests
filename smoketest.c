...
static void (*p_game_fn_nothing)(void* grug_state);
static union grug_value (*p_game_fn_magic)(void* grug_state);
static void (*p_game_fn_initialize)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_initialize_bool)(void* grug_state, const union grug_value args[]);
static union grug_value (*p_game_fn_identity)(void* grug_state, const union grug_value args[]);
static union grug_value (*p_game_fn_max)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_say)(void* grug_state, const union grug_value args[]);
static union grug_value (*p_game_fn_sin)(void* grug_state, const union grug_value args[]);
static union grug_value (*p_game_fn_cos)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_mega)(void* grug_state, const union grug_value args[]);
static union grug_value (*p_game_fn_get_false)(void* grug_state);
static void (*p_game_fn_set_is_happy)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_mega_f32)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_mega_i32)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_draw)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_blocked_alrm)(void* grug_state);
static void (*p_game_fn_spawn)(void* grug_state, const union grug_value args[]);
static union grug_value (*p_game_fn_has_resource)(void* grug_state, const union grug_value args[]);
static union grug_value (*p_game_fn_has_entity)(void* grug_state, const union grug_value args[]);
static union grug_value (*p_game_fn_has_string)(void* grug_state, const union grug_value args[]);
static union grug_value (*p_game_fn_get_opponent)(void* grug_state);
static union grug_value (*p_game_fn_get_os)(void* grug_state);
static void (*p_game_fn_set_d)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_set_opponent)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_motherload)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_motherload_subless)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_offset_32_bit_f32)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_offset_32_bit_i32)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_offset_32_bit_string)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_talk)(void* grug_state, const union grug_value args[]);
static union grug_value (*p_game_fn_get_position)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_set_position)(void* grug_state, const union grug_value args[]);
static void (*p_game_fn_cause_game_fn_error)(void* grug_state);
static void (*p_game_fn_call_on_b_fn)(void* grug_state);
static void (*p_game_fn_store)(void* grug_state, const union grug_value args[]);
static union grug_value (*p_game_fn_retrieve)(void* grug_state);
static union grug_value (*p_game_fn_box_number)(void* grug_state, const union grug_value args[]);
